...
9. **handyman_joe** - Joe Handyman (San Francisco, CA)
   - Verified user, offers repair services
   
10. **tutor_sarah** - Sarah Teacher (Berkeley, CA)
    - Verified user, offers tutoring
   
11. **chef_mike** - Mike Chef (Oakland, CA)
    - Verified user, offers cooking lessons
...
- Some users are marked as "verified" to demonstrate the verification feature
