...
function CreateOffer() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // Note: frequency and duration might need backend support
      ...
      if (response.ok) {
        ...
        setError(
          errorData.message || "Failed to create offer. Please try again."
        );
      }
    } catch (error) {
              ...
              <div className="form-group">
                ...
                <div className="people-count-container">
                  <div className="people-input-wrapper">
                    <label htmlFor="minPeople" className="people-input-label">
                      Min
                    </label>
                    <input
                      type="number"
                  ...
                  <div className="people-input-wrapper">
                    <label htmlFor="maxPeople" className="people-input-label">
                      Max
                    </label>
                    <input
                      type="number"
